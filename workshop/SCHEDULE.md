...
The planned schedule for the September 2022 Data Lab Virtual Training Workshop appears below.
...
| Time        | Topic                             | Location |
|-------------|--------------------------------------------|----------------|
| **Day 1**   | **Monday 2022-09-19** <br> [_**Introduction to R and the Tidyverse**_](https://github.com/alexslemonade/training-modules/blob/{{site.release_tag}}/intro-to-R-tidyverse#readme) |
...
| 1:00 PM     | Introduction to R and RStudio <br> [Introduction to R and RStudio slides (PDF)](../slides/2022-09-19_Intro-R-RStudio.pdf) <br> [Introduction to base R](https://htmlpreview.github.io/?https://github.com/AlexsLemonade/training-modules/blob/{{site.release_tag}}/intro-to-R-tidyverse/01-intro_to_base_R.nb.html) | Zoom: [Main Session](../virtual-setup/zoom-procedures.md#joining-a-zoom-call)|
...
| 5:00  PM    | End             |
| **Day 2**   | **Tuesday 2022-09-20**  <br> [_**Introduction to Single-cell RNA-seq, Day 1**_](https://github.com/AlexsLemonade/training-modules/tree/master/scRNA-seq#readme)|
...
|             | [Consultation session](workshop-structure.md#consultation-sessions) | [Slack channel](../virtual-setup/slack-procedures.md#general-use) |
| 5:00  PM    | End             |
| **Day 4**   | **Thursday 2022-09-22**  <br> [_**Introduction to Pathway Analysis**_](https://github.com/AlexsLemonade/training-modules/tree/master/scRNA-seq#readme)| |
...
|             | [Consultation session](workshop-structure.md#consultation-sessions) | [Slack channel](../virtual-setup/slack-procedures.md#general-use)|
| 5:00 PM     | End ||
| **Day 5**   | **Friday 2022-09-23**  <br> _**Consultation and Presentations**_ |
